...
const { validate, messageSchemas, commonSchemas } = require('../middleware/validation');
...
// @access  Private
router.get('/conversations', authenticateToken, validate(commonSchemas.pagination, 'query'), asyncHandler(async (req, res) => {
  ...
  res.json({
    ...
    data: {
      ...
      pagination: {
        ...
        pages: Math.ceil(conversationList.length / limit)
      }
    }
  });
}));
...
// @access  Private
router.get('/conversation/:userId', authenticateToken, validate(commonSchemas.pagination, 'query'), asyncHandler(async (req, res) => {
...
// @access  Private
router.post('/', authenticateToken, validate(messageSchemas.create), asyncHandler(async (req, res) => {
...
// @access  Private
router.get('/search', authenticateToken, validate(commonSchemas.search, 'query'), asyncHandler(async (req, res) => {
...
// @access  Private
router.post('/bulk-read', authenticateToken, asyncHandler(async (req, res) => {
...
// @access  Private
router.delete('/conversation/:userId', authenticateToken, asyncHandler(async (req, res) => {
  const { userId } = req.params;
