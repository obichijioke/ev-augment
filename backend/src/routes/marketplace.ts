...
// @access  Private
router.post('/', authenticateToken, validate(marketplaceSchemas.create), asyncHandler(async (req: Request, res: Response) => {
  const listingData = {
    ...req.body,
...
router.put('/:id', authenticateToken, requireOwnership('id', 'seller_id'), validate(marketplaceSchemas.update), asyncHandler(async (req: Request, res: Response) => {
  const { id } = req.params;
...
// @access  Private (Owner only)
router.delete('/:id', authenticateToken, requireOwnership('id', 'seller_id'), asyncHandler(async (req: Request, res: Response) => {
  const { id } = req.params;
...
// @access  Private (Owner only)
router.post('/:id/images', authenticateToken, requireOwnership('id', 'seller_id'), asyncHandler(async (req: Request, res: Response) => {
  const { id } = req.params;
...
// @access  Private
router.post('/:id/contact', authenticateToken, asyncHandler(async (req: Request, res: Response) => {
  const { id } = req.params;
  ...
  if (listing.seller_id === (req as any).user.id) {
