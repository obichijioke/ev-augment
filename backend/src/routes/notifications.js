...
const { validate, notificationSchemas } = require('../middleware/validation');
...
router.post('/', authenticateToken, requireModerator, validate(notificationSchemas.create), asyncHandler(async (req, res) => {
  const {
    recipient_id,
    type,
    title,
...
// @access  Private
router.put('/preferences', authenticateToken, validate(notificationSchemas.updatePreferences), asyncHandler(async (req, res) => {
...
// @access  Private (Moderator only)
router.post('/broadcast', authenticateToken, requireModerator, validate(notificationSchemas.broadcast), asyncHandler(async (req, res) => {
  const {
    title,
    message,
    priority = 'medium',
...
// @access  Private (Moderator only)
router.post('/test', authenticateToken, requireModerator, asyncHandler(async (req, res) => {
