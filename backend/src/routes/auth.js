...
const { asyncHandler, notFoundError, validationError, unauthorizedError, createError } = require('../middleware/errorHandler');
...
// @access  Public
router.post('/forgot-password', validate(userSchemas.forgotPassword), asyncHandler(async (req, res) => {
...
// @access  Public
router.post('/reset-password', validate(userSchemas.resetPassword), asyncHandler(async (req, res) => {
