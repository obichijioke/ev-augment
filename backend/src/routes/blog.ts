...
// @access  Public
router.get('/posts', optionalAuth, validate(commonSchemas.pagination, 'query'), asyncHandler(async (req: AuthenticatedRequest, res: express.Response) => {
  const { page, limit, category, tag, author, sort, sortBy, q, status } = req.query;
  ...
  // Apply sorting
  const validSortFields = ['created_at', 'published_at', 'updated_at', 'views', 'title'];
...
router.post('/posts', authenticateToken, requireModerator, validate(blogSchemas.create), asyncHandler(async (req: AuthenticatedRequest, res: express.Response) => {
  const postData = {
    ...req.body,
...
// @access  Public
router.get('/posts/:slug', optionalAuth, asyncHandler(async (req: AuthenticatedRequest, res: express.Response) => {
  ...
  if (post.status === 'published' && (!req.user || (req.user as any).id !== post.author_id)) {
    await supabaseAdmin
      .from('blog_posts')
...
router.put('/posts/:id', authenticateToken, validate(blogSchemas.update), asyncHandler(async (req: AuthenticatedRequest, res: express.Response) => {
  const { id } = req.params;
...
// @access  Private (Author or Moderator)
router.delete('/posts/:id', authenticateToken, asyncHandler(async (req: AuthenticatedRequest, res: express.Response) => {
  const { id } = req.params;
...
// @access  Public
router.get('/posts/:id/comments', validate(commonSchemas.pagination, 'query'), asyncHandler(async (req: express.Request, res: express.Response) => {
  const { id } = req.params;
...
// @access  Private
router.post('/posts/:id/comments', authenticateToken, validate(blogSchemas.createComment), asyncHandler(async (req: AuthenticatedRequest, res: express.Response) => {
...
// @access  Private (Author or Moderator)
router.put('/comments/:id', authenticateToken, validate(blogSchemas.updateComment), asyncHandler(async (req: AuthenticatedRequest, res: express.Response) => {
  const { id } = req.params;
...
// @access  Private (Author or Moderator)
router.delete('/comments/:id', authenticateToken, asyncHandler(async (req: AuthenticatedRequest, res: express.Response) => {
  const { id } = req.params;
...
// @access  Public
router.get('/search', validate(commonSchemas.search, 'query'), asyncHandler(async (req: express.Request, res: express.Response) => {
...
// @access  Public
router.get('/author/:authorId', validate(commonSchemas.pagination, 'query'), asyncHandler(async (req: express.Request, res: express.Response) => {
