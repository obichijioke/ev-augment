...
// @access  Public
router.get('/posts', optionalAuth, validate(commonSchemas.pagination, 'query'), asyncHandler(async (req: Request, res: Response) => {
...
// @access  Private
router.post('/posts', authenticateToken, validate(forumSchemas.createPost), asyncHandler(async (req: Request, res: Response) => {
  const postData = {
    ...req.body,
...
// @access  Public
router.get('/posts/:id', optionalAuth, asyncHandler(async (req: Request, res: Response) => {
  const { id } = req.params;
...
router.put('/posts/:id', authenticateToken, validate(forumSchemas.updatePost), asyncHandler(async (req: Request, res: Response) => {
  const { id } = req.params;
  ...
  const isModerator = (req as any).user.role === 'moderator' || (req as any).user.role === 'admin';
...
// @access  Private (Author or Moderator)
router.delete('/posts/:id', authenticateToken, asyncHandler(async (req: Request, res: Response) => {
  const { id } = req.params;
...
// @access  Private
router.post('/posts/:id/replies', authenticateToken, validate(forumSchemas.createReply), asyncHandler(async (req: Request, res: Response) => {
...
// @access  Private (Author or Moderator)
router.put('/replies/:id', authenticateToken, validate(forumSchemas.updateReply), asyncHandler(async (req: Request, res: Response) => {
  const { id } = req.params;
...
// @access  Private (Author or Moderator)
router.delete('/replies/:id', authenticateToken, asyncHandler(async (req: Request, res: Response) => {
  const { id } = req.params;
...
router.post('/posts/:id/pin', authenticateToken, requireModerator, asyncHandler(async (req: Request, res: Response) => {
  const { id } = req.params;
...
// @access  Private (Moderator only)
router.post('/posts/:id/lock', authenticateToken, requireModerator, asyncHandler(async (req: Request, res: Response) => {
  const { id } = req.params;
...
// @access  Public
router.get('/user/:userId/posts', validate(commonSchemas.pagination, 'query'), asyncHandler(async (req: Request, res: Response) => {
