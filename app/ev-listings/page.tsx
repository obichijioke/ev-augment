  ...
  return (
    <div className="bg-gray-50 min-h-screen py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-4">Electric Vehicle Database</h1>
          <p className="text-gray-600">Explore and compare electric vehicles from all manufacturers. Browse specifications, features, and discover the perfect EV for your needs.</p>
        </div>
          ...
          <div className="lg:col-span-3">
            ...
            <div className={viewMode === 'grid' ? 'grid grid-cols-1 md:grid-cols-2 gap-6' : 'space-y-6'}>
              {filteredVehicles.map((vehicle) => (
                <div key={vehicle.id} className="bg-white rounded-lg border border-gray-100 overflow-hidden hover:shadow-xs transition-shadow duration-200">
                  <div className="relative">
                    ...
                    <div className="absolute top-4 left-4">
                      <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${getAvailabilityColor(vehicle.availability)}`}>
                  ...
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-lg font-semibold text-blue-600">View Specifications</span>
                    </div>
                    
                    <p className="text-gray-600 mb-4">{vehicle.brand} • {vehicle.year} • {vehicle.bodyType}</p>
                    
                    <div className="grid grid-cols-2 gap-4 mb-4">
                      <div className="flex items-center space-x-2">
                        <Battery className="h-4 w-4 text-blue-600" />
                        <span className="text-sm text-gray-600">{vehicle.range} miles</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Zap className="h-4 w-4 text-yellow-600" />
                        <span className="text-sm text-gray-600">{vehicle.chargingSpeed}</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Clock className="h-4 w-4 text-green-600" />
                        <span className="text-sm text-gray-600">{vehicle.acceleration} 0-60</span>
                      </div>
                      <div className="flex items-center space-x-2">
                    ...
                    <div className="flex items-center justify-between text-sm text-gray-500 mb-4">
                      ...
                      <div className="flex items-center space-x-1">
                        ...
                        <span>{vehicle.likes} likes</span>
                      </div>
                    </div>
                    
                    <div className="flex space-x-2">
                      <Link href={`/ev-listings/${vehicle.id}`} className="flex-1 btn-primary text-center">
                        View Details
                      </Link>
                      <button 
                        onClick={() => toggleVehicleSelection(vehicle.id)}
