  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900 min-h-screen">
      ...
      <section className="relative bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 text-white py-20 md:py-32 overflow-hidden">
        ...
        <div
          className="absolute top-40 right-20 w-32 h-32 bg-blue-300/20 rounded-full blur-2xl animate-bounce"
          style={{ animationDuration: "3s" }}
        ></div>
        <div
          className="absolute bottom-20 left-1/4 w-16 h-16 bg-indigo-300/15 rounded-full blur-lg animate-pulse"
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-10 text-blue-100 max-w-3xl mx-auto leading-relaxed">
              Connect with passionate EV enthusiasts, discover cutting-edge
              vehicles, and be part of the sustainable transportation revolution
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
              <Link
                href="/forums"
                className="group bg-white text-blue-600 hover:bg-blue-50 font-semibold py-4 px-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 flex items-center space-x-2"
              >
              ...
              <Link
                href="/ev-listings"
                className="group bg-transparent border-2 border-white/30 backdrop-blur-sm text-white hover:bg-white/10 hover:border-white font-semibold py-4 px-8 rounded-xl transition-all duration-300 transform hover:-translate-y-1 flex items-center space-x-2"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card
              ...
              title="Forums"
              description="Join discussions about EVs, charging, and more"
            />
            ...
            <Card
              ...
              title="Marketplace"
              description="Buy and sell EVs, parts, and accessories"
            />
            ...
            <Card
              ...
              title="Garage"
              description="Showcase your EV and connect with owners"
            />
            ...
            <Card
              ...
              title="Directory"
              description="Find EV businesses and services near you"
            />
          </div>
        </div>
      </section>
