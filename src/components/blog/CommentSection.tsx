          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              <textarea
                ...
                rows={3}
              ></textarea>
              <button type="submit" className="mt-2 btn-primary">Submit Comment</button>
            </div>
          </div>
        </form>
      ) : (
        <div className="text-center p-4 border border-gray-200 rounded-lg bg-gray-50">
          <p>Please <a href="/auth/login" className="text-blue-600 hover:underline">log in</a> to post a comment.</p>
        </div>
      )}
          ...
          <div key={comment.id} className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              <div className="flex items-center justify-between">
                ...
                <p className="text-sm text-gray-500">{new Date(comment.publishedAt).toLocaleDateString('en-US', { month: 'short', day: 'numeric' })}</p>
              </div>
