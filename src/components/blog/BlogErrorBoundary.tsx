...
import { AlertTriangle, RefreshCw, BookOpen, FileText, MessageSquare } from 'lucide-react';
        ...
        <div className="min-h-[400px] flex items-center justify-center">
          <div className="text-center max-w-md mx-auto p-6">
            ...
            <p className="text-gray-600 mb-6">
              We encountered an error while loading the blog content. Please try refreshing the page.
            </p>
...
export const BlogCommentsEmpty: React.FC<{ 
  ...
  <div className="text-center py-8">
    ...
    <p className="text-sm text-gray-500 mb-4">Be the first to share your thoughts!</p>
    {onAddComment && (
      <button
