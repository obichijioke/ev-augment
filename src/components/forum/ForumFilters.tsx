          ...
          <div className="relative">
            ...
            <div className="flex items-center space-x-2">
              ...
              <select
                ...
                onChange={(e) =>
                  handleFilterChange(e.target.value as ThreadFilterOption)
                }
                className="border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-900 text-gray-900 dark:text-white"
              >
          ...
          <div className="relative">
            ...
            <div className="flex items-center space-x-2">
              ...
              <select
                value={filters.sort}
                onChange={(e) =>
                  handleSortChange(e.target.value as ThreadSortOption)
                }
                className="border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-900 text-gray-900 dark:text-white"
              >
          ...
          <div className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-300">
            ...
            {filters.filter !== "all" && (
              <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200">
                {
                  filterOptions.find((opt) => opt.value === filters.filter)
                    ?.label
                }
                <button
                  onClick={() => handleFilterChange("all")}
                  className="ml-1 text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-white"
                >
                  ×
                </button>
              </span>
