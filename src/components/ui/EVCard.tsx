...
const EVCard: React.FC<EVCardProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-lg transition-all duration-300 hover:border-blue-300 dark:hover:border-blue-500/40">
      <Link href={`/ev-listings/${vehicleData.id}`} className="block">
        <div className="relative">
          ...
          <div className="absolute bottom-3 left-3 bg-white/90 dark:bg-gray-900/80 backdrop-blur-sm px-2 py-1 rounded-full text-xs font-medium text-gray-800 dark:text-gray-200">
            {vehicleData.year}
          </div>
          {vehicleData.msrp && (
      ...
      <div className="px-4 pb-4 border-t border-gray-100 dark:border-gray-700 pt-3 flex items-center justify-between">
